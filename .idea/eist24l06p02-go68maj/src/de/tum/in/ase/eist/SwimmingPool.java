...
public class SwimmingPool {
    ...
    private static final SwimmingPoolActionOrder swimmingPoolActionOrder = SwimmingPoolActionOrder.CHANGING_ROOM_BEFORE_LOCKER;
    ...
    public void handleEntryRequestDeadlockFree(Swimmer swimmer, SwimmingPoolActionOrder order) {
        ...
        if (swimmingPoolActionOrder == order){

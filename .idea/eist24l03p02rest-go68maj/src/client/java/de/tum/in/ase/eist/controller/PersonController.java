...
public class PersonController {
    ...
    public void addPerson(Person person, Consumer<List<Person>> personsConsumer) {
        webClient.post().uri("persons").bodyValue(person).retrieve().bodyToMono(Person.class).onErrorStop().subscribe(newPerson ->{
    ...
    public void getAllPersons(PersonSortingOptions sortingOptions, Consumer<List<Person>> personsConsumer) {
        webClient.get()
                .uri(uriBuilder -> uriBuilder
                        .path("persons")
                        .queryParam("sortField", sortingOptions.getSortField().toString())
                        .queryParam("sortingOrder", sortingOptions.getSortingOrder().toString())
                        .build())
                .retrieve()
                ...
                .subscribe(persons -> {
                    ...
                    personsConsumer.accept(this.persons);
                });
    }

...
# This script sets up the AWS resources needed for the exercises. It should be
# executed before starting the exercises. It requires the AWS CLI to be
# installed and configured. It also requires the localstack container to be
# running.

# The endpoint is the address of the localstack container.
ENDPOINT=http://localhost:4566
# The region is not important for localstack, but we need to specify it anyway.
REGION=us-east-1
